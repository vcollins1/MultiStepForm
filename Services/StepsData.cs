...
public class StepsData
{
    ...
    public static readonly (int Id, string Title, string Description, decimal Price)[] AddOns =
    [
        (0, "Online service", "Access to multiplayer games", 1),
        (1, "Larger storage", "Extra 1TB of cloud save", 2),
        (2, "Customizable profile", "Custom theme on your profile", 2)
    ];
}
